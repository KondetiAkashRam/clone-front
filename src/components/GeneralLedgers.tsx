...
export const GeneralLedgers: React.FC = () => {
  ...
  const [form, setForm] = useState({
    ...
    amount: '',
    type: 'debit',
    category: 'general-ledgers', // Add category to form state
    dashboardCategory: ''
  });
  ...
  const handleCreate = async () => {
    ...
    const newTransaction = {
      ...
      category: form.category || 'general-ledgers',
    ...
    setShowModal(false);
    setForm({ date: '', description: '', amount: '', type: 'debit', category: 'general-ledgers', dashboardCategory: '' });
              ...
              <tbody>
                {filteredLedgers.map((ledger, index) => (
                  <tr key={ledger.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-6 text-sm text-gray-900">{ledger.name || ledger.description}</td>
